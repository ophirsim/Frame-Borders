...
def round_corners_one_image(original_image, percent_of_side=.1):
    ...
    drawing_layer.polygon([(radius,radius),(radius,height-radius),(width-radius,height-radius),(width-radius,radius)], fill=(127,0,127,255))

    # Uncomment the following line to show the mask
    # plt.imshow(rounded_mask)
    
    # Make the new image, starting with all transparent
    backroundsmall = PIL.Image.open("backround.jpg")
    result = backroundsmall.resize((width, height))
